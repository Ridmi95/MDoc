...
public class MainActivity extends AppCompatActivity implements ProductAdapter.ProductAdapterStatus {
    ...
    private TextView cart_list, empty_cart;
    ...
    private void paymentButtonStyle() {
        if (products.size() == 0) {
            ...
            payment_parent.setCardBackgroundColor(Color.parseColor(getString(R.color.colorPrimaryDark)));
        }
    }
    ...
    private void initProducts() {
        ...
        products.add(new Product(7845, getString(R.string.item_1), R.drawable.item_1));
        products.add(new Product(7994, getString(R.string.item_2), R.drawable.item_2));
        products.add(new Product(7456, getString(R.string.item_3), R.drawable.item_3));
        products.add(new Product(1258, getString(R.string.item_4), R.drawable.item_4));
    ...
    public void changeFragment(View view){
        Fragment fragment;
        if (view == findViewById(R.id.btnInsert)) {
            fragment = new InsertFragment();
            FragmentManager fm = getSupportFragmentManager();
            FragmentTransaction ft = fm.beginTransaction();
            ft.replace(R.id.defFrag,fragment);
            ft.commit();
        }
    }
}
